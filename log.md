...
And I now truly understand how event listeners work and how the object and it's properties can be acessed when passing a parameter (event) to the  callback function, for example: 
```
